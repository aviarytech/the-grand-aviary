...
import { Button, Col, Container, Row, Spinner, Nav, Navbar } from 'react-bootstrap';
  ...
  return (
    <div>
      ...
      <Navbar bg="primary" variant="dark" expand="lg" className="mb-4">
        <Container>
          <Navbar.Brand href="#home">Visitor Management System</Navbar.Brand>
          <Navbar.Toggle aria-controls="basic-navbar-nav" />
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="me-auto">
              <Nav.Link href="#home">Active VC</Nav.Link>
              <Nav.Link href="#about">Revoked VC</Nav.Link>
